...
namespace Gpp.Api.Platform
{
    internal partial class PlatformApi : GppApi
    {
        ...
        internal void VerifyStoreReceipt(StoreReceipt receipt, string platform, string funnelType, ResultCallback<VerifiedReceipt> callback)
        {
            Run(RequestVerifyStoreReceipt(receipt, platform, funnelType, callback));
        }

        internal void VerifyStoreReceipts(List<StoreReceipt> receipts, string platform, string funnelType, ResultCallback<Dictionary<string, VerifiedReceipt>> callback)
        {
            Run(RequestVerifyStoreReceipts(receipts, platform, funnelType, callback));
        }
