...
namespace Gpp.Models
{
    internal class GppClientLogModels
    {
        internal class LogType
        {
            ...
            public const string KOS_EVENT_FUNNEL = "kos_event_funnel";
        }
    ...
    internal class Funnel
        {
            internal class Purchase
            {
                internal class Type
                {
                    public const string REPAYMENT_FUNNEL = "repayment_funnel";
                    public const string STORE_PURCHASE_FUNNEL = "store_purchase_funnel";
                    public const string PURCHASE_RECOVERY_FUNNEL = "purchase_recovery_funnel";
                }
                
                internal class Repayment
                {
                    public const string REPAY_USER_ENTRY = "repay_user_entry";
                    public const string TRIGGER_PURCHASE_RECOVERY = "trigger_purchase_recovery";
                    public const string REQUEST_REPAY_LIST = "request_repay_list";
                    public const string REPAY_STATUS = "repay_status";
                    public const string REPAY_INCOMPLETE = "repay_incomplete";
                    public const string REPAY_COMPLETE = "repay_complete";
                    public const string SHOW_REPAY_POPUP = "show_repay_popup";
                    public const string REPAY_BLOCKED = "repay_blocked";
                    public const string SHOW_REPAY_LIST = "show_repay_list";
                    public const string CLICK_CUSTOMER_SERVICE = "click_customer_service";
                    public const string CLICK_ACCOUNT_SWITCH = "click_account_switch";
                    public const string CLICK_REPAY_PER_PRODUCT = "click_repay_per_product";
                    public const string STORE_PURCHASE_TRY = "store_purchase_try";
                    public const string STORE_PURCHASE_TRY_FAIL = "store_purchase_try_fail";
                    public const string STORE_PURCHASE_TRY_SUCCESS = "store_purchase_try_success";
                    public const string REQUEST_VALIDATION = "request_validation";
                    public const string RECEIVE_VALIDATION_RESULT = "receive_validation_result";
                    public const string VALIDATION_FAIL = "validation_fail";
                    public const string VALIDATION_SUCCESS = "validation_success";
                    public const string REQUEST_STORE_CONSUME = "request_store_consume";
                    public const string STORE_CONSUME_FAIL = "store_consume_fail";
                    public const string STORE_CONSUME_SUCCESS = "store_consume_success";
                }

                internal class StorePurchase
                {
                    public const string START_PURCHASE = "start_purchase";
                    public const string CHECK_PURCHASE_POLICY = "check_purchase_policy";
                    public const string PURCHASE_BLOCKED = "purchase_blocked";
                    public const string STORE_PURCHASE_TRY = "store_purchase_try";
                    public const string STORE_PURCHASE_TRY_FAIL = "store_purchase_try_fail";
                    public const string STORE_PURCHASE_TRY_SUCCESS = "store_purchase_try_success";
                    public const string REQUEST_VALIDATION_GRANT = "request_validation_grant";
                    public const string RECEIVE_VALIDATION_GRANT_RESULT = "receive_validation_grant_result";
                    public const string VALIDATION_GRANT_FAIL = "validation_grant_fail";
                    public const string VALIDATION_GRANT_SUCCESS = "validation_grant_success";
                    public const string REQUEST_STORE_CONSUME = "request_store_consume";
                    public const string STORE_CONSUME_FAIL = "store_consume_fail";
                    public const string STORE_CONSUME_SUCCESS = "store_consume_success";
                }
                
                internal class PurchaseRecovery
                {
                    public const string TRIGGER_PURCHASE_RECOVERY = "trigger_purchase_recovery";
                    public const string CHECK_UNCONSUMED_LIST = "check_unconsumed_list";
                    public const string REQUEST_VALIDATION_GRANT = "request_validation_grant";
                    public const string RECEIVE_VALIDATION_GRANT_RESULT = "receive_validation_grant_result";
                    public const string VALIDATION_GRANT_FAIL = "validation_grant_fail";
                    public const string VALIDATION_GRANT_SUCCESS = "validation_grant_success";
