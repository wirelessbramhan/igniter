...
{
    public class GppPcSurveyUI : MonoBehaviour, IGppToastUI
    {
        ...
        {
            var titleText = GppUtil.FindChildWithName<TextMeshProUGUI>(gameObject, "TitleText");
            titleText.text = _toastMessage.Message;
        }

        private void SetMessage()
        {
            var messageText = GppUtil.FindChildWithName<TextMeshProUGUI>(gameObject, "MessageText");
            messageText.text = _toastMessage.SubMessage;
        }
        
        private void LocalizeText()
        {
            var participateText = GppUtil.FindChildWithName<TextMeshProUGUI>(gameObject, "ParticipateText");
            var doNotShowAgainText = GppUtil.FindChildWithName<TextMeshProUGUI>(gameObject, "DoNotShowAgainButton");
            var closeText = GppUtil.FindChildWithName<TextMeshProUGUI>(gameObject, "CloseButton");
        ...
        {
            var background = GppUtil.FindChildWithName(gameObject, "Background");
